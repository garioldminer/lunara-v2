          ...
          >
            ...
            >
              ...
              <div style={{ position: 'relative', width: 96, height: 96, margin: '0 auto 16px auto' }}>
                ...
                >
                  <Flame size={28} style={{ color: '#3a1a00' }} />
                </motion.div>
              </div>
            ...
            {/* Progress Bar */}
            {nextMilestone && (
              <div style={{ padding: '16px 24px', borderBottom: '1px solid rgba(197, 160, 89, 0.15)', flexShrink: 0 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                  <span style={{ fontSize: '12px', fontWeight: 600, color: '#C5A059' }}>Next reward: {nextMilestone.days} days</span>
                  <span style={{ fontSize: '12px', color: '#94a3b8' }}>{currentStreak}/{nextMilestone.days}</span>
                </div>
                <div style={{ height: '6px', borderRadius: '999px', overflow: 'hidden', backgroundColor: 'rgba(255,255,255,0.05)' }}>
                  <motion.div 
                    initial={{ width: 0 }}
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '14px', fontWeight: 700, color: milestone.claimed ? '#10b981' : '#ffe566', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '4px' }}>
                      <Gem size={14} />
                      {milestone.reward}
                    </div>
                  </div>
